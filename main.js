...
ASSET_MANAGER.queueDownload("./sprites/pangolin_win_screen.png");
...
ASSET_MANAGER.queueDownload("./sounds/Fuse.mp3");
ASSET_MANAGER.queueDownload('./sounds/Level2Background.mp3');
